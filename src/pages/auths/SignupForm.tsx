...
export const SignupForm = () => {
    ...
    const { initialSignupValue, handleSignupSubmit, updateSignupFormData} = useAuthForm()
  return (
    <div className="w-full md:w-[70%]">
        ...
        <TextField
          ...
          <TextField
            ...
            postAppend={textType === 'text' ? <SlEye onClick={() =>setTextType('password')} /> : <BsEyeSlash onClick={() =>setTextType('text')} />}
            onBlur={handleBlur}
